...
public interface ITourService
{
    ...
    Task<TourResponse> GetTourAsync(string authorId, Guid tourId);
    Task<PublicTourResponse> GetPublicTourAsync(string userId, string authorizationHeader, Guid tourId);
    ...
    Task<TourResponse> UpdateTourAsync(string authorId, Guid tourId, UpdateTourRequest request);
