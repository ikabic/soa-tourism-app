...
type Profile struct {
	...
	CurrentLatitude  *float64  `json:"current_latitude,omitempty" gorm:"type:double precision;default:null"`
	CurrentLongitude *float64  `json:"current_longitude,omitempty" gorm:"type:double precision;default:null"`
